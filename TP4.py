"""
Patrick Morin 405 TP4 : Introduction à la programmation OO
"""
...
class Humain:
    def __init__(self):
        self.message = "J'aime les cochons."
...
Patrick = Hero("Patrick")
print(f"{Patrick.nom} a {Patrick.nombre_de_vie} point(s) de vie")
print(f"{Patrick.nom} a {Patrick.force_attack} point(s) de vie")
print(f"{Patrick.nom} est  vivant: {Patrick.est_vivant()} ")
